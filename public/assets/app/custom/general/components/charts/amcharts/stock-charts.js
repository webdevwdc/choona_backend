    ...
    var demo3 = function() {
        ...
        function generateChartData() {
            ...
            $.ajax({
                ...
                'async': false,
                'global': false,
                url:window.location.protocol+"/admin/job/posted/count/perday",
                success: function(res){
                    $.each(res.data, function( index, value ) {
                        // console.log(value._id);
                        var cDate = new Date(value._id.year, value._id.month-1, value._id.day);
        ...
        $('.amcharts-chart-div a').each(function() {
            var text = $(this).text();
            $(this).text(text.replace('JS chart by amCharts', '')); 
        });
    }
